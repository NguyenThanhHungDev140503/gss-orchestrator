...
# These discovery file references moved to subskills phase files during modular refactoring
assert_contains "$ROOT/subskills/PHASE-00-INTAKE.md" ".planning/CURRENT_STATE.md"
assert_contains "$ROOT/subskills/PHASE-00-INTAKE.md" ".planning/CODEBASE_MAP.md"
assert_contains "$ROOT/subskills/PHASE-00-INTAKE.md" ".planning/BASELINE.md"
assert_contains "$ROOT/subskills/PHASE-00-INTAKE.md" ".planning/DOCS_INGEST.md"
assert_contains "$ROOT/subskills/PHASE-00-INTAKE.md" ".planning/INTEGRATION_RISKS.md"
...
# These discovery file references moved to subskills-codex phase files during modular refactoring
assert_contains "$ROOT/subskills-codex/PHASE-00-INTAKE.md" ".planning/CURRENT_STATE.md"
assert_contains "$ROOT/subskills-codex/PHASE-00-INTAKE.md" ".planning/CODEBASE_MAP.md"
assert_contains "$ROOT/subskills-codex/PHASE-00-INTAKE.md" ".planning/BASELINE.md"
assert_contains "$ROOT/subskills-codex/PHASE-00-INTAKE.md" ".planning/DOCS_INGEST.md"
assert_contains "$ROOT/subskills-codex/PHASE-00-INTAKE.md" ".planning/INTEGRATION_RISKS.md"
