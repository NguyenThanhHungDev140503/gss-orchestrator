...
assert_contains "$ROOT/subskills-codex/PHASE-08-DEBUG.md" '$systematic-debugging'
...
assert_contains "$ROOT/SKILL.codex.md" 'PROJECT_INTAKE'
assert_contains "$ROOT/SKILL.codex.md" 'PROJECT_DISCOVERY'
assert_contains "$ROOT/subskills-codex/PHASE-02-PLANNING.md" 'PROJECT_MODE="<new_project-or-existing_project-or-existing_project_with_planning>"'
assert_contains "$ROOT/SKILL.codex.md" 'CURRENT_STATE.md'
assert_contains "$ROOT/SKILL.codex.md" 'CODEBASE_MAP.md'
assert_contains "$ROOT/subskills-codex/PHASE-02-PLANNING.md" 'delta roadmap'
...
assert_contains "$ROOT/SKILL.codex.md" 'SP_DEBUGGING'
assert_contains "$ROOT/SKILL.codex.md" 'DEBUG_REPORT.md'
assert_contains "$ROOT/subskills-codex/PHASE-02-PLANNING.md" 'DEVEX_RATIONALE="<one-sentence-rationale-from-planning-output>"'
assert_contains "$ROOT/subskills-codex/PHASE-03b-DX.md" 'DEVEX_RATIONALE=$(jq -r'
assert_contains "$ROOT/subskills-codex/PHASE-03b-DX.md" 'do not spawn the DX review subagent'
...
assert_contains "$ROOT/SKILL.md" 'PROJECT_INTAKE'
assert_contains "$ROOT/SKILL.md" 'PROJECT_DISCOVERY'
assert_contains "$ROOT/subskills/PHASE-02-PLANNING.md" 'PROJECT_MODE=$(echo'
assert_contains "$ROOT/subskills/PHASE-00-INTAKE.md" 'subagent_type: "gss-discoverer"'
assert_contains "$ROOT/SKILL.md" 'CURRENT_STATE.md'
assert_contains "$ROOT/SKILL.md" 'CODEBASE_MAP.md'
assert_contains "$ROOT/subskills/PHASE-02-PLANNING.md" 'delta roadmap'
...
assert_contains "$ROOT/SKILL.md" 'SP_DEBUGGING'
assert_contains "$ROOT/SKILL.md" 'DEBUG_REPORT.md'
assert_contains "$ROOT/subskills/PHASE-02-PLANNING.md" 'DEVEX_RATIONALE=$(echo'
assert_contains "$ROOT/subskills/PHASE-03b-DX.md" 'DEVEX_RATIONALE=$(jq -r'
assert_contains "$ROOT/subskills/PHASE-03b-DX.md" 'do not dispatch `gss-devex-reviewer`'
assert_contains "$ROOT/subskills/PHASE-06-QA.md" 'Review type: QA'
assert_contains "$ROOT/subskills/PHASE-03-REVIEW.md" 'subagent_type: "gss-reviewer"'
assert_contains "$ROOT/subskills/PHASE-03b-DX.md" 'subagent_type: "gss-devex-reviewer"'
assert_contains "$ROOT/subskills/PHASE-03c-DESIGN.md" 'subagent_type: "gss-designer"'
assert_contains "$ROOT/subskills/PHASE-07-DOCS.md" 'subagent_type: "gss-docs"'
assert_contains "$ROOT/subskills/PHASE-08-DEBUG.md" 'subagent_type: "gss-debugger"'
assert_not_contains "$ROOT/SKILL.md" 'subagent_type: "gss-qa"'
assert_not_contains "$ROOT/SKILL.md" 'QA FAILED: [paste issues[] from GStack QA JSON]"'
assert_not_contains "$ROOT/SKILL.md" 'DESIGN QA FAILED: [paste issues[] from gss-designer JSON]"'
assert_contains "$ROOT/README.md" 'GSTACK_DESIGN_PLAN'
assert_contains "$ROOT/README.md" 'PROJECT_INTAKE'
assert_contains "$ROOT/README.md" 'PROJECT_DISCOVERY'
assert_contains "$ROOT/README.md" 'gss-discoverer'
assert_contains "$ROOT/README.md" 'delta roadmap'
...
assert_contains "$ROOT/README.md" 'SP_DEBUGGING'
assert_contains "$ROOT/README.md" 'gss-debugger'
...
assert_contains "$ROOT/install_codex.sh" '- systematic-debugging'
...
assert_contains "$ROOT/install.sh" 'gss-discoverer.md'
assert_contains "$ROOT/install.sh" 'gss-devex-reviewer.md'
assert_contains "$ROOT/install.sh" 'gss-debugger.md'
assert_contains "$ROOT/install.sh" 'required subagent missing'
assert_contains "$ROOT/install.sh" 'if [ "$INSTALL_AGENTS" = true ]; then'

for agent in "$ROOT/agents/gss-discoverer.md" "$ROOT/agents/gss-devex-reviewer.md" "$ROOT/agents/gss-designer.md" "$ROOT/agents/gss-docs.md" "$ROOT/agents/gss-debugger.md"; do
  if [ ! -f "$agent" ]; then
...
assert_contains "$ROOT/agents/gss-discoverer.md" '# Current State'
assert_contains "$ROOT/agents/gss-discoverer.md" '# Codebase Map'
assert_contains "$ROOT/agents/gss-discoverer.md" '# Baseline Verification'
assert_contains "$ROOT/agents/gss-discoverer.md" '# Docs Ingest'
assert_contains "$ROOT/agents/gss-discoverer.md" '# Integration Risks'
assert_contains "$ROOT/agents/gss-discoverer.md" '"status": "DISCOVERY_COMPLETE"'
assert_contains "$ROOT/agents/gss-devex-reviewer.md" 'plan-devex-review'
assert_contains "$ROOT/agents/gss-devex-reviewer.md" '# Developer Experience Review'
assert_contains "$ROOT/agents/gss-devex-reviewer.md" '## Time To Hello World'
...
assert_contains "$ROOT/agents/gss-debugger.md" 'superpowers:systematic-debugging'
assert_contains "$ROOT/agents/gss-debugger.md" 'DEBUG_REPORT.md'
assert_contains "$ROOT/agents/gss-debugger.md" 'Root Cause'
