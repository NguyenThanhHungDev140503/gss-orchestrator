...
assert_contains "$ROOT/SKILL.codex.md" '$systematic-debugging'
...
assert_contains "$ROOT/SKILL.codex.md" 'PROJECT_MODE="<new_project-or-existing_project-or-existing_project_with_planning>"'
assert_contains "$ROOT/SKILL.codex.md" 'CURRENT_STATE.md'
assert_contains "$ROOT/SKILL.codex.md" 'CODEBASE_MAP.md'
assert_contains "$ROOT/SKILL.codex.md" 'delta roadmap'
...
assert_contains "$ROOT/SKILL.codex.md" 'DEVEX_RATIONALE="<one-sentence-rationale-from-planning-output>"'
assert_contains "$ROOT/SKILL.codex.md" 'DEVEX_RATIONALE=$(jq -r'
assert_contains "$ROOT/SKILL.codex.md" 'do not spawn the DX review subagent'
...
assert_contains "$ROOT/SKILL.md" 'PROJECT_MODE=$(echo'
assert_contains "$ROOT/SKILL.md" 'subagent_type: "gss-discoverer"'
assert_contains "$ROOT/SKILL.md" 'CURRENT_STATE.md'
assert_contains "$ROOT/SKILL.md" 'CODEBASE_MAP.md'
assert_contains "$ROOT/SKILL.md" 'delta roadmap'
...
assert_contains "$ROOT/SKILL.md" 'DEVEX_RATIONALE=$(echo'
assert_contains "$ROOT/SKILL.md" 'DEVEX_RATIONALE=$(jq -r'
assert_contains "$ROOT/SKILL.md" 'do not dispatch `gss-devex-reviewer`'
...
assert_contains "$ROOT/SKILL.md" 'subagent_type: "gss-debugger"'
